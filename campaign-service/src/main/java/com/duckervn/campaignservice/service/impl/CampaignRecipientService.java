...
public class CampaignRecipientService implements ICampaignRecipientService {
    ...
    private void validateRecipientId(String userId, boolean isRequired) {
        ...
        ListenableFuture<Map<String, Object>> listenableFuture = eventProducer.publish(serviceConfig.getCheckUserExistRK(), requestMap, true);
        Map<String, Object> resultMap = listenableFuture.get();

        log.info("Result back: {}", objectMapper.writeValueAsString(resultMap));
